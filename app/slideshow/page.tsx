  ...
  return (
    <SidebarLayout slideshowControls={slideshowControls}>
      ...
      <div className="relative flex flex-col min-h-0 max-w-screen overflow-x-hidden">
        <div 
          id="slideshow-item"
          className="w-full h-screen flex items-center justify-center m-0 p-0 border border-gray-600 shadow-[0_0_10px_rgba(255,255,255,0.1)]"
        >
          {mediaItems.length > 0 && (
            <>
              <div className="w-full flex flex-col items-start justify-start m-0 p-0">
                ...
                <div className="w-full max-w-[100vw] md:max-w-4xl mx-auto text-white text-center m-0 p-0 bg-black-500 media-caption">
