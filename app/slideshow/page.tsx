              ...
              <div className="relative w-full h-full flex items-center justify-center p-4">
                {currentItem.file_type.startsWith('image/') ? (
                  <div className="relative w-full h-full flex items-center justify-center">
                    <div className="relative w-full h-full max-w-[90dvw] max-h-[calc(100dvh-6rem)]">
                      <Image
                        ...
                        fill
                        sizes="90vw"
                        className="object-contain w-full p-8 rounded-lg border-solid border-amber-500"
                        priority
                        quality={100}
                        unoptimized={false}
                  ...
                  <div className="relative w-full h-full flex items-center justify-center">
                    <video
                      src={currentItem.file_path}
                      className="max-w-[90dvw] max-h-[calc(100dvh-6rem)] object-contain glass-card w-full p-8 rounded-lg border border-amber-500/30"
                      autoPlay
                      loop
                      playsInline
                      controls
